...
const QuestionDisplay: React.FC<Props> = ({ question, selectedAnswer, onSelect, showFeedback }) => {
  const getBadgeColor = (type: QuestionType) => {
    switch (type) {
      ...
      case QuestionType.REGULATION:
        return 'bg-purple-100 text-purple-800';
      case QuestionType.ETHICS:
  ...
  // Näytä kuva vain niissä kysymyksissä joissa kuva kuuluu asiaan.
  // Tämä estää harmaat "kuvapaikat" esim. safety/regulation -kysymyksissä.
  const shouldShowImage = question.type === QuestionType.IDENTIFICATION;
